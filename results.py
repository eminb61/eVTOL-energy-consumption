...
heatmap_speed_distance('fleet_size', 'Optimal Fleet Size', 'energy_and_flight_time/wind_variation_result_1000pax.sqlite', 180)
heatmap_wind_direction_speed('fleet_size', 'Optimal Fleet Size', 'energy_and_flight_time/wind_variation_result_1000pax.sqlite', 60)
line_plot_vs_distance('number_of_repositioning_flights', 'Repositioning Flights', 'energy_and_flight_time/wind_variation_result_1000pax.sqlite')
line_plot_metric_vs_speed('number_of_repositioning_flights', 'Repositioning Flights', 'energy_and_flight_time/wind_variation_result_1000pax.sqlite', 180)
line_plot_vs_distance('fleet_size', 'Optimal Fleet Size', 'energy_and_flight_time/wind_variation_result_1000pax.sqlite')
line_plot_metric_vs_speed('fleet_size', 'Optimal Fleet Size', 'energy_and_flight_time/wind_variation_result_1000pax.sqlite', 0)
surface_plot('number_of_repositioning_flights', 'Repositioning Flights', [20, 60], 'energy_and_flight_time/wind_variation_result_1000pax.sqlite')
surface_plot('fleet_size', 'Optimal Fleet Size', [20, 60], 'energy_and_flight_time/wind_variation_result_1000pax.sqlite')
